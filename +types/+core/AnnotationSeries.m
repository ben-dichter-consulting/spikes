...
methods
    function obj = AnnotationSeries(varargin)
        ...
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1.0, 'float32') 'data_resolution' types.util.correctType(-1.0, 'float') 'data_unit' 'n/a' 'description' 'no description' 'help' 'Time-stamped annotations about an experiment'} varargin];
