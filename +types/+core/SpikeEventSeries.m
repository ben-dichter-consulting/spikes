...
methods
    function obj = SpikeEventSeries(varargin)
        ...
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1.0, 'float32') 'data_resolution' types.util.correctType(0.0, 'float32') 'data_unit' 'volt' 'description' 'no description' 'help' 'Snapshots of spike events from data.' 'timestamps_interval' types.util.correctType(1, 'int32') 'timestamps_unit' 'Seconds'} varargin];
