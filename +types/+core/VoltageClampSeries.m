...
methods
    function obj = VoltageClampSeries(varargin)
        ...
        varargin = [{'capacitance_fast_unit' 'Farad' 'capacitance_slow_unit' 'Farad' 'comments' 'no comments' 'description' 'no description' 'help' 'Current recorded from cell during voltage-clamp recording' 'resistance_comp_bandwidth_unit' 'Hz' 'resistance_comp_correction_unit' 'percent' 'resistance_comp_prediction_unit' 'percent' 'whole_cell_capacitance_comp_unit' 'Farad' 'whole_cell_series_resistance_comp_unit' 'Ohm'} varargin];
