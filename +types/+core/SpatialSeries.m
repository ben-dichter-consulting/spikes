...
methods
    function obj = SpatialSeries(varargin)
        ...
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1.0, 'float32') 'data_resolution' types.util.correctType(0.0, 'float32') 'data_unit' 'meter' 'description' 'no description' 'help' 'Stores points in space over time. The data[] array structure is [num samples][num spatial dimensions]'} varargin];
