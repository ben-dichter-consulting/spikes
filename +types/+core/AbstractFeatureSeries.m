...
methods
    function obj = AbstractFeatureSeries(varargin)
        ...
        % features = char
        % feature_units = char
        varargin = [{'comments' 'no comments' 'data_conversion' types.util.correctType(1.0, 'float32') 'data_resolution' types.util.correctType(0.0, 'float32') 'data_unit' 'see `feature_units`' 'description' 'no description' 'help' 'Features of an applied stimulus. This is useful when storing the raw stimulus is impractical'} varargin];
